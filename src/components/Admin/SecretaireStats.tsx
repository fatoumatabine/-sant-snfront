...
export const SecretaireStats: React.FC = () => {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
      <StatCard
        ...
        value={stats.secretaires?.total || 0}
      ...
      <StatCard
        ...
        title="RDV Gérés"
        value={stats.secretaires?.rdv_geres_ce_mois || 0}
        subtitle="Ce mois"
      ...
      <StatCard
        ...
        title="Consultations"
        value={stats.secretaires?.consultations_enregistrees || 0}
